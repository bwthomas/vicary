...
|---|---|---|
| Python | [`vicary`](https://pypi.org/project/vicary/) on PyPI | **published** — see [`python/`](python/) |
| TypeScript | `vicary` on npm | in progress — see [`typescript/`](typescript/) |
| Ruby | `vicary` on RubyGems | in progress — see [`ruby/`](ruby/) |
